...
<body>
		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right mainNav">
					...
					<li class="active"><a href="price.php">SUMC Shop</a></li>
	...
	<section class="container">
		<div class="heading">
			<!-- Heading -->
			<h3>SUMC Projets</h3>
			<p>As sunningdale umc we sale a range of products from our PROJECTS TEAM </p>
			<br />
		</div>
		<div class="row flat">
			<div class="col-lg-3 col-md-3 col-xs-6">
				<ul class="plan plan1">
					<li class="plan-name">Ngoma Hymm Book
					</li>
					<li class="plan-price">
						<strong>$10</strong> Fee
					</li>
					  
					
					<li class="plan-action">
						<a href="http://wa.me/+263719666892?text=I+want+to+buy+;"" class="btn">CONTACT</a>
					</li>
				</ul>
			</div>
			...
			<div class="col-lg-3 col-md-3 col-xs-6">
				<ul class="plan plan2 featured">
					<li class="plan-name">Shona Bible
					</li>
					<li class="plan-price">
						<strong>$20</strong> Fee
					</li>
			...
			<div class="col-lg-3 col-md-3 col-xs-6">
				<ul class="plan plan3">
					<li class="plan-name">Car Parking
					</li>
					<li class="plan-price">
						<strong>$1</strong> Per Night
					</li>
			...
			<div class="col-lg-3 col-md-3 col-xs-6">
				<ul class="plan plan4">
					<li class="plan-name">English Bible
					</li>
					<li class="plan-price">
						<strong>$20</strong> Fee
					</li>
